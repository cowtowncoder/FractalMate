...

{
    ...
    public
    HelpViewer(Frame parent, Fractlet fr, Applet a,
  ...
  /*** ActionListener-interface: ***/
	...
	try {
		...
		if (currentPage == null) {
		    ...
		    document.setSize(document.prefSize.width,
				     document.prefSize.height);
		    currentPage = addr;
		    return;
		}
		...
		scrPane.doLayout();
		document.setSize(document.prefSize.width,document.prefSize.height);
	    }
	} catch (IOException ie) {
