...
import com.cowtowncoder.fractalmate.io.Loader;
    ...
    FractletListener
{
  ...
  public Hashtable initPopups(Object [] defs)
  {
      Menu last_menu = null;
...
//  private void checkSelectionString() { }
  ...
  public boolean checkPopup(MouseEvent e, FractalSegment [] fs)
  {
      boolean line = false;
...
//System.err.println("Loading fractal image, saved by Fractlet version: <unknown>");
  ...
  FractalSegment[] constructPattern(LoadedDef def)
  {
  ...
  void createUndo(int oper, int index)
  {
      addUndo(Undo.createUndo(oper, index, view, undo), false);
  }

  void createUndo(int oper, int index, FractalSegment f)
  {
      addUndo(Undo.createUndo(oper, index, view, f, undo), false);
  }

  void createUndo(int oper, int index, FractalSegment [] fs)
  {
