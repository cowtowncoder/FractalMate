...
package com.cowtowncoder.fractalmate.util;
...
import com.cowtowncoder.fractalmate.HelpViewer;
        ...
        MouseListener, MouseMotionListener, Runnable
{
	...
	"/lt=</gt=>/amp=&/quot=\"/copy=(c)/auml=�/ouml=�/Auml=�/Ouml=�/";
    ...
    // Font information:
    public static int defaultRowHeight,  defaultFontWidth;
...
//System.err.println("LOAD IMAGE, props="+properties+", src="+properties.src);
    ...
    // Images and tables float, if they are aligned to the left or right:
    @Override
