    ...
    extends Label
{
    ...
    public MinLabel(String text, String mintext)
    {
	super(text);
    ...
    public MinLabel(String text, int minx, int miny)
	throws AWTException
    {
	super(text);
    ...
    public void setMinimumSize(int minx, int miny)
            throws AWTException
    {
	if (minx < 0 || miny < 0)
    ...
    public void setMinimumSize(String mins)
    {
	minText = mins;
	minX = minY = 0;	
    }
