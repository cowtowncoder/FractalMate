...
package com.cowtowncoder.fractalmate.ext;
...
{
    public final static Object getPNGEncoder(Image im, OutputStream out)
    {
	try {
    ...
    public final static Object getJPEGEncoder(Image im, OutputStream out, int quality)
    {
